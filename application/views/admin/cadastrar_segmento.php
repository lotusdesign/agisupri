	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-file"></i> Cadastrar Segmentos</li>
						</ol>
					</div>
				</div>
				<!-- /.row -->
				<div class="row">
					<div class="col-lg-6">
						<form role="form" class="formcliente" action="/agisupri/index.php/admin/salvar_segmento" method="post" name="frm_segmento">
							<input type="hidden" name="id_segmento">
							<div class="form-group">
								<label>Nome do Segmento</label> <input type="text" class="form-control" name="nome_segmento">
							</div>
                            <br/>
							<button type="submit" name="salvar" class="btn btn-sm btn-primary">ADICIONAR SEGMENTO</button>
							...
							<table class="table table-bordered table-hover tabelacliente">
								...
								<tbody>
									<?php foreach ($segmentos as $segmento) { ?>
										<tr>
											<td><?php echo $segmento['nome_segmento'] ?></td>
											<td>
												<a href="/agisupri/index.php/admin/carregar_segmento/<?php echo $segmento['id_segmento'] ?>" 
													title="Editar" class="fa fa-pencil-square-o"></a>
												<a href="/agisupri/index.php/admin/excluir_segmento/<?php echo $segmento['id_segmento'] ?>" 
