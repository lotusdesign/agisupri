	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Cadastrar Segmentos</h1>
						<ol class="breadcrumb">
							<li><i class="fa fa-dashboard"></i> <a href="index.html">Tela Inicial</a></li>
							<li><i class="fa fa-file"></i> <a href="/agisupri/index.php/admin/cadastrar_segmento">Cadastrar Segmentos</a></li>
							<li class="active"><i class="fa fa-file"></i> Editar Segmento</li>
						</ol>
					</div>
				</div>
				<!-- /.row -->
				<div class="row">
					<div class="col-lg-6">
						<form role="form" class="formcliente" action="/agisupri/index.php/admin/salvar_edicao_segmento" method="post" name="frm_segmento">
							<input type="hidden" name="id_segmento" value="<?php echo $segmento['id_segmento']?>">
							<div class="form-group">
								<label>Nome do Segmento</label> 
									<input type="text" class="form-control" name="nome_segmento" 
													   value="<?php echo $segmento['nome_segmento']?>">
							</div>
                            <br/>
							<button type="submit" name="salvar" class="btn btn-sm btn-primary">SALVAR ALTERAÇÃO</button>
							<button onclick="location.href='/agisupri/index.php/admin/cadastrar_segmento';" class="btn btn-sm btn-primary">CANCELAR</button>
						</form>
					</div>
				</div>
			</div>
