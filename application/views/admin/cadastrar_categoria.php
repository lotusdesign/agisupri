	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-6">
						<form role="form" class="formcliente" action="/agisupri/index.php/admin/salvar_categoria" method="post" name="frm_categoria">
							...
							<div class="form-group">
								<label>Nome da Categoria:</label> <input type="text" class="form-control" name="nome_categoria">
							</div>
                            <br/>
							<button type="submit" name="salvar" class="btn btn-sm btn-primary">ADICIONAR CATEGORIA</button>
								...
								<tbody>
									<?php foreach ($categorias as $categoria) { ?>
										<tr>
											...
											<td><?php echo $categoria['nome_segmento'] ?></td>
											<td>
												<a href="/agisupri/index.php/admin/carregar_categoria/<?php echo $categoria['id_categoria'] ?>" 
													title="Editar" class="fa fa-pencil-square-o"></a>
												<a href="/agisupri/index.php/admin/excluir_categoria/<?php echo $categoria['id_categoria'] ?>" 
